...
<div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	<div class="container">
		...
		<div class="navbar-header ">
			...
			<a class="" href="<?=$us_url_root?>users/upload/upload.php"><img class="img-responsive" src="<?=$us_url_root?>users/images/logo.png" alt="" /></a>
		</div>
...
$x = $query->results(true);
              ...
              echo("<li class='hidden-sm hidden-md hidden-lg'><i class='fa fa-fw fa'></i> </a></li>"); 
               ...
               ?>
                 ...
                 <li class='hidden-sm hidden-md hidden-lg'><a href='<?=$us_url_root?>users/upload/delete_upload.php'><i class='fa fa-fw fa-cut'></i>Delete Folder</a></li>
					...
					<li><a href="<?=$us_url_root?>users/upload/create_folder.php"><i class="fa fa-fw fa-book"></i> <?php echo "Create Folder";?></a></li> <!-- Common for Hamburger and Regular menus link -->

                    <li><a href="<?=$us_url_root?>users/upload/upload_file.php" ><i class="fa fa-fw fa-upload"></i> <?php echo "Upload Files";?></a></li> <!-- Common for Hamburger and Regular menus link -->
...
$x = $query->results(true);
         ...
         echo("<li><a href=$us_url_root"."users/upload/delete_upload.php><i class='fa fa-fw fa-cut'></i>Delete Folder</a></li>");
